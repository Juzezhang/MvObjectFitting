...
parser.add_argument('--output_path', type=str, default="/nas/nas_10/AI-being/ZJY/vis")
...
mocap_path = join(args.root_path, args.seq_name, 'output')
seq_step = args.step
...
for object_name in object_names:
    ...
    object_template_path = join(args.root_path, 'Objects_template', object_name, object_name + '_simplified_transformed.obj')
    # object_mesh = Mesh()
...
for frame_count in tqdm(range(start_frame, end_frame), desc="Processing frames"):
    ...
    smpl_param_path = join(mocap_path, 'smpl', f'{str(frame_count).zfill(6)}.json')
